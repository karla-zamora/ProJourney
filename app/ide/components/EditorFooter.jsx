        ...
        <div className="flex bg-dark-layer-1 absolute bottom-0 z-10 w-full">
            <div className="mx-5 my-[10px] flex justify-between w-full">
                ...
                <div className="ml-auto flex items-center space-x-4">
                    <button
                        className={`px-3 py-1.5 text-sm font-medium items-center whitespace-nowrap transition-all focus:outline-none inline-flex ${isCodeRunning ? 'bg-dark-gray-3' : 'bg-dark-fill-3 hover:bg-dark-fill-2'
                        ...
                        disabled={isCodeRunning} // while running
                    >
                        {isCodeRunning ? (
                            <><span className="loader mr-2"></span>Running...</>
                        ) : (
                            'Run'
                        )}
                    </button>
