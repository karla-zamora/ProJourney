...
export default function Waitlist() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center waitlist-pg">
            <div className="bg-white p-8 rounded-lg shadow-lg max-w-md lg:w-full">
                <h2 className="text-2xl font-semibold text-center mb-2">
                    Join Our Waitlist
                </h2>
                <h3 className="text-2g text-center mb-6">
                    Be the first to know about our release!
                </h3>
                ...
                {message && (
                    <div
                        className={`mt-4 p-3 text-sm rounded-lg ${messageType === "success"
